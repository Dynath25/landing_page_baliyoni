    ...
    <div class="max-w-screen-xl mx-auto px-6 sm:px-6 lg:px-8">
        ...
        <div class="relative mx-auto max-w-screen-xl px-4 flex items-center justify-center">
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative z-10">
                    <div class="w-[650px] h-[550px] bg-white rounded-2xl overflow-hidden shadow-lg flex flex-col">
                        ...
                        <div class="h-1/2 w-full">
                            ...
                            @if (isset($img1_url))
                                <img src="{{ $img1_url }}" alt="Gambar Tentang Kami 1"
                        ...
                        <div class="h-1/2 w-full">
                            {{-- Ganti placeholder di bawah ini dengan gambar Anda --}}
                            @if (isset($img2_url))
                                <img src="{{ $img2_url }}" alt="Gambar Tentang Kami 2"
                                    class="w-full h-full object-cover">
                            @endif
                        </div>
                    </div>
                ...
                <div
                    class="relative z-20 -ml-24 bg-neutral-900 rounded-3xl p-8 shadow-2xl w-[500px] h-[600px] flex flex-col">
                    ...
                    {{-- Tombol Learn More --}}
                    <button
                        class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-md text-sm font-medium transition-colors duration-200 self-start">
                        Learn more
                    </button>
                </div>
            </div>
